...
token = "1084897879:AAFtTJ77OhSS1H8c34AyIh3TqAspXOqtxR4"
...
def reply_virus ( message):
    sticker_id = 'CAACAgIAAxkBAAI3rF56LAFIimupkXXo3_jY_bPC8Q4bAALEAAMw1J0RyMW8vArrFUoYBA'
    bot.send_sticker(message.chat_id,sticker_id)
